...
@section('title', 'Admin | Halaman Data Warga Bantuan Pemerintah')

@section('content')
<div class="pagetitle">
    <h1>Pengelolaan Data Warga Bantuan Pemerintah</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Home</a></li>
        <li class="breadcrumb-item">Table</li>
        <li class="breadcrumb-item active">Data Warga Bantuan Pemerintah</li>
      </ol>
    </nav>
</div><!-- End Page Title -->
...
<section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
              <h5 class="card-title">Data Warga Bantuan Pemerintah</h5>

...
@section('title', 'Admin | Halaman Edit Data RT')

@section('content')
<div class="pagetitle">
    <h1>Formulir Edit Data RT</h1>
    <nav>
      <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <form class="row g-3" action="{{ route('DataRT.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-12">

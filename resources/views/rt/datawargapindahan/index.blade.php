...
@section('title', 'Admin | Halaman Data Warga Pindahan')
        ...
        <div class="card">
          <div class="card-body">
              <h5 class="card-title">Data Warga Pindahan</h5>
                <table class="table table-striped table-bordered dt-responsive nowrap w-100 display" id="tableWargaPindahanRT">
                    <thead>
                        <tr>
                            <th width="70px">No</th>
                            <th>NO KK</th>
...
@push('customjs')
    <script>
        var datatable = $('#tableWargaPindahanRT').DataTable({
            processing: true,
            serverSide: true,
            ordering: true,
            ajax: '{!! url()->current() !!}',
